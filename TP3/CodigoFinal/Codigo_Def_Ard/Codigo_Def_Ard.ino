...
int valorDigital2 = 0;         // Registro 6
int Presion1 = 0;              // Registro 7
int Presion2 = 0;              // Registro 8


int estadoPulsador1;              // Estado actual del pulsador1
int ultimoEstadoPulsador1 = HIGH; // Estado anterior del pulsador1
int estadoPulsador2;              // Estado actual del pulsador2
int ultimoEstadoPulsador2 = HIGH; // Estado anterior del pulsador2
...
void loop() {
  ...
  // Detecta flanco de bajada (cuando se presiona el pulsador)
  if (estadoPulsador1 == LOW && ultimoEstadoPulsador1 == HIGH) {
    Presion1 = 1 - Presion1; // Alterna entre 0 y 1
 ...
 // Detecta flanco de bajada (cuando se presiona el pulsador)
  if (estadoPulsador2 == LOW && ultimoEstadoPulsador2 == HIGH) {
    Presion2 = 1 - Presion2; // Alterna entre 0 y 1
